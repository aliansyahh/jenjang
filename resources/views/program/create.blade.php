...
<div class="content mt-3">
    <div class="card">
        <div class="card-header">
            <div class="pull-left">
                <strong>Tambah Data Jenjang</strong>
            </div>
                    ...
                    <form action="{{url('/Programs')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control @error('nama')
                                is-invalid
                            @enderror" autocomplete="off" value="{{old('nama')}}">
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            @enderror">
                                ...
                                @foreach ($edulevel as $item)
                                    <option value="{{$item->id}}" {{old('edulevel_id')  == $item->id? 'selected':'' }}>{{$item->nama}}</option>
                                @endforeach
                            </select>
                            @error('edulevel_id')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="studen_price" id="studen_price" class="form-control @error('studen_price')
                                is-invalid
                            @enderror" value="{{old('studen_price')}}">
                            @error('studen_price')
                            <div class="invalid-feedback">
                                {{$message}}
                              </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="student_max" id="student_max" class="form-control @error('student_max')
                                is-invalid
                            @enderror" value="{{old('student_max')}}">
                            @error('student_max')
                            <div class="invalid-feedback">
                                {{$message}}
                              </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('info')
                                is-invalid
                            @enderror" name="info" id="info" >{{old('info')}}</textarea>
                            @error('info')
                            <div class="invalid-feedback">
                                {{$message}}
                              </div>
